(()=>{'use strict';
const beats=[
{start:0,end:10,bg:'a01.webp',fg:'n01.webp',side:'right',bgCam:[1.05,-.03,.014,-.45,1.11,.018,-.012,.22],fgCam:[.28,.88,.31,-4,.33,.82,.34,1],seed:1.1,density:.20,shape:'sliver',bgGrade:[1.12,1.16,1.10],fgGrade:[1.14,1.18,1.10]},
{start:10,end:15,bg:'a04.webp',fg:'n10.webp',side:'left',bgCam:[1.08,.022,.02,.35,1.15,-.024,-.018,-.24],fgCam:[.31,.16,.70,4,.38,.23,.62,-2],seed:2.0,density:.27,shape:'corner',bgGrade:[1.12,1.18,1.10],fgGrade:[1.16,1.22,1.12]},
{start:15,end:20,bg:'a03.webp',fg:'n07.webp',side:'right',bgCam:[1.08,-.03,.02,-.32,1.15,.026,-.018,.28],fgCam:[.36,.84,.27,-2,.44,.76,.35,2],seed:2.9,density:.36,shape:'vertical',bgGrade:[1.13,1.20,1.11],fgGrade:[1.17,1.24,1.12]},
{start:20,end:25,bg:'n03.webp',fg:'n06.webp',side:'left',bgCam:[1.10,.02,.021,.40,1.18,-.022,-.02,-.36],fgCam:[.37,.17,.68,2,.47,.25,.61,-2],seed:3.8,density:.45,shape:'low',bgGrade:[1.13,1.20,1.11],fgGrade:[1.17,1.26,1.12]},
{start:25,end:30,bg:'a08.webp',fg:'a11.webp',side:'right',bgCam:[1.06,-.022,.018,-.26,1.14,.022,-.015,.22],fgCam:[.35,.84,.72,-2,.43,.77,.63,2],seed:4.7,density:.56,shape:'diagonal',bgGrade:[1.14,1.24,1.12],fgGrade:[1.18,1.28,1.13]},
{start:30,end:35,bg:'n02.webp',fg:'n05.webp',side:'left',bgCam:[1.09,.022,.018,.30,1.17,-.024,-.02,-.28],fgCam:[.41,.15,.29,2,.50,.25,.37,-2],seed:5.6,density:.68,shape:'island',bgGrade:[1.15,1.28,1.13],fgGrade:[1.20,1.32,1.14]},
{start:35,end:40,bg:'n11.webp',fg:'n09.webp',side:'right',bgCam:[1.12,-.024,.018,-.32,1.22,.026,-.018,.24],fgCam:[.46,.83,.70,-2,.58,.74,.62,2],seed:6.5,density:.82,shape:'poster',bgGrade:[1.18,1.36,1.15],fgGrade:[1.22,1.40,1.16]},
{start:40,end:44,bg:'a13.webp',fg:'n04.webp',side:'left',bgCam:[1.24,.018,.012,.18,1.42,-.022,-.012,-.14],fgCam:[.66,.15,.24,1,.82,.23,.32,-1],seed:7.4,density:1.00,shape:'monolith',bgGrade:[1.22,1.46,1.17],fgGrade:[1.26,1.50,1.18]},
{start:44,end:48,bg:'a20.webp',fg:'n12.webp',side:'right',bgCam:[1.28,-.016,.010,-.16,1.48,.018,-.010,.12],fgCam:[.70,.85,.66,-1,.90,.76,.58,1],seed:8.3,density:1.08,shape:'split',bgGrade:[1.24,1.52,1.19],fgGrade:[1.28,1.54,1.19]},
{start:48,end:52,bg:'a02.webp',fg:'n08.webp',side:'left',bgCam:[1.34,.014,.008,.12,1.56,-.016,-.010,-.10],fgCam:[.78,.16,.28,1,.98,.25,.35,-1],seed:9.2,density:1.16,shape:'full',bgGrade:[1.26,1.56,1.20],fgGrade:[1.30,1.58,1.20]}];
...
function preload(){const paths=new Set(['surface.webp']);beats.forEach(b=>{paths.add(b.bg);paths.add(b.fg)});return Promise.all([...paths].map(src=>new Promise((res,rej)=>{const img=new Image();img.decoding='async';img.onload=()=>{images.set(src,img);res()};img.onerror=rej;img.src=src})))}
